...
const Navbar = ({
  ...
  const scrollToSection = (sectionId) => {
    ...
    // Calculate total offset needed to show content below navbar
    const navbarHeight = 80;        // Height of fixed navbar
    const extraPadding = 60;        // Extra breathing room above content
    const totalOffset = navbarHeight + extraPadding;  // 140px total
